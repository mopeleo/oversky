    ...
    <div>
        <el-form ref="gameinfoForm" :model="gameinfo" :rules="rules" label-width="120px"  :disabled="editType === this.$pubdefine.EDIT_TYPE_DETAIL">
            <el-form-item label="游戏简称" prop="gamename">
                <el-input v-model="gameinfo.gamename" :disabled="editType === this.$pubdefine.EDIT_TYPE_UPDATE"></el-input>
            </el-form-item>
            <el-form-item label="游戏编号" prop="gamecode">
                <el-input v-model="gameinfo.gamecode" :disabled="editType === this.$pubdefine.EDIT_TYPE_UPDATE"></el-input>
            </el-form-item>
