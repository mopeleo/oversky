...
public class ServerPlayerEquip extends DLEntity{
	...
	public String getEntityKey(){
		...
		return build.append(this.serverid).append(this.custno).append(this.equipid).toString();
	}

    public static String buildEntityKey(String serverid, Long custno, String equipid){
        StringBuilder build = new StringBuilder("ServerPlayerEquip");
        return build.append(serverid).append(custno).append(equipid).toString();
    }
