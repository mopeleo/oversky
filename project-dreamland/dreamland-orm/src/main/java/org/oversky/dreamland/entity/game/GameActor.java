...
public class GameActor extends BaseEntity{
	...
	private Double ratiomagic;    //默认魔力成长率
	...
	public Double getRatiomagic() {
		return this.ratiomagic;
	}

	public void setRatiomagic(Double ratiomagic) {
	...
	public String buildEntityKey(){
		StringBuilder build = new StringBuilder("GameActor");
    ...
    public void copyPrimaryKey(GameActor entity){
    ...
    public String toString() {
		...
		sb.append("ratiomagic=").append(ratiomagic).append(", ");
