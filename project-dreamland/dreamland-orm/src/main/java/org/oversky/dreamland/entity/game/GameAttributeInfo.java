...
public class GameAttributeInfo extends BaseEntity{
	...
	public String buildEntityKey(){
		...
		return build.append("#attrid:").append(this.attrid).toString();
	}

    public static String buildEntityKey(Long attrid){
        StringBuilder build = new StringBuilder("GameAttributeInfo");
        return build.append("#attrid:").append(attrid).toString();
    }
    
    public void copyPrimaryKey(GameAttributeInfo entity){
