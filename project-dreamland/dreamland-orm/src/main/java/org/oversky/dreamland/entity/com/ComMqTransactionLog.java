...
public class ComMqTransactionLog extends BaseEntity{
	...
	public String buildEntityKey(){
		StringBuilder build = new StringBuilder("ComMqTransactionLog");
    ...
    public void copyPrimaryKey(ComMqTransactionLog entity){
